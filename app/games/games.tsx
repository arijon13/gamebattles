...
interface GameProps {
  ...
  criteria: Criteria; // Legger til kriterier som en ny prop
}

export default function Games({ gameId, gameImage, matches, tournaments, criteria }: GameProps) {
